...
A first approach would be to use a technique called **PCA** (principal components analysis). This technique is useful if you want to get a composite score and a ranking: 
